...
/*
$(()=>{
        Bu şekilde de document ready yazılabilir.
});
*/

$(document).ready(function(){ //callback func.
...
const changeColor = () => {
    ...
    // console.log([rangeRed.val(), rangeGreen.val(), rangeBlue.val()]); //değer okuma
    ...
    pickerDiv.html(color).css("background-color", color).css("color", colorRev); //yukarıdaki gibi tek tek yazmak yerine clear code şeklinde zincirleme yazdık
};